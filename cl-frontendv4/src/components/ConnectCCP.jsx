...
const ConnectCCP = ({ phoneNum, buyer_Identifier }) => {
  ...
  const outBoundCall = async () => {
    ...
    try {
      console.log("[SOURCE PHONE]:", sourcePhone, "[DEST PHONE]:", destPhone, "[QUEUE ARN]:", queueARN, "[INSTANCE ID]:", instanceId, "[CONTACT FLOW ID]:", contactFlowId, "[BUYER IDENTIFIER]:", buyer_Identifier);
      // Make API call
