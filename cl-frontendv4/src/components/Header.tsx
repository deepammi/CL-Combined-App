...
const Header = ({
  ...
  const logout = async () => {
    try {
      const endpoint = process.env.NEXT_PUBLIC_API_BASEURL || 'http://localhost:4000/api/v1';
    ...
    <header>
      <div className="mx-auto px-20 py-10 relative">
        <div className="flex flex-wrap justify-center xl:justify-between items-center gap-12">
          <div
            className={`lg:text-black text-2xl font-extrabold z-40 ${theme === "dark" ? "text-black" : "text-white"
              }`}
          >
